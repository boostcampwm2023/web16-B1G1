...
2.
3. 회원가입하고 은하 들어가는 것까지
4. 코치마크 보여주기
5. leva로 조절하는 것 보여주기
6. 은하 수정하는 것 보여주기
7. 글쓰기 창 보여주기
8. 글쓰기 이후 별 커스텀하는 창 보여주기 -> 실제 생성된 별 보여주기
9. 별 클릭해서 수정하고 삭제하는 화면
10. 공유 모달에서 검색 상태 수정하는 화면
11. 공유 링크 복사해서 실제로 들어가는 화면
12. 다른 사람 은하 검색해서 들어가는 화면
